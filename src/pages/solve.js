  ...
  return (
    ...
    >
      <>
        ...
        <Img alt="Project timeline including user analysis, content analysis, information architecture, technical architecture, feature prioritization, software development for the initial release, and then iterative feature design and devleopment with ongoing releases" style={{margin: '4rem 0', borderRadius: '8px'}} fluid={data.solvetimeline.childImageSharp.fluid}></Img>
        <div className="bodyTextWrapper">
          <h2>User Research</h2>
          <div className="overview">
            <p>For the first iteration of the platform, I chose to focus our team's efforts on the needs of two user groups whose buy-in would be key to eventual platform adoption and success: <strong>Faculty at Postsecondary Institutions</strong> and the <strong>Every Learner Everywhere Content Team.</strong> We conducted first and second-hand interviews with these groups to develop the following personas.</p>
          </div>           
        </div>
           ...
           <div className="columnLayout">
              <div className="column personaImageContainer">
                ...
                <p className="caption">Our access to faculty and administrators at postsecondary institutions was unfortunately extremely limited. We addressed this constraint by conducting 1-on-1 interviews with four "technical assistance" partners who were working directly with these faculty.</p>
              </div>
            ...
            <div className="columnLayout">
              ...
              <div className="column personaImageContainer">
                <Img alt="Faceless cartoon image of a woman in a sweater" className="personaImage flipImage" fluid={data.assetteam.childImageSharp.fluid}></Img>
        ...
        <div className="bodyTextWrapper overview">
            ...
            <p>These personas' knowledge finding and knowledge management paint points guided our creation of the following "how might we" statements, which drove our thinking throughout the first build of the platform.</p>
            <p>1. How might we create a content experience that is cohesive, actionable, and digestible for institution faculty?</p>
            <p>2. How might we create a scalable content management system that gives the Every Learner team full control over content creation, review, and publishing?</p>
          </div>
          <div className="bodyTextWrapper">
            <h2>Information Architecture</h2>
            <div className="overview">
              <p>One of this project's key challenges was a contractual platform completion date set for <strong>months before the creation of almost all of the content</strong> that would live on it. Thus, rather than developing the platform with a specific scale or medium in mind, we had to approach the content architecture iteratively.</p>
            </div>
            
            </div>
            <div className="columnLayout">
              <div className="column personaImageContainer">
                <Img alt="Images of 4 documents on digital learning" className="personaImage" fluid={data.contentanalysis.childImageSharp.fluid}></Img>
              </div>
              <div className="column personaText">
                <h3 style={{marginTop: '1rem'}}>Content Analysis</h3>
                <h4>Process</h4>
                <p>We analyzed over 30 resources that had already been created by Network partners in this space (before the Network was formed), as well as some of the materials that were in progress for the platform.</p>
                <h4>Findings</h4>
                <ul>
                  <li>Most resources were comprised almost entirely of text and image, though some contained video</li>
                  <li>Most resources were 10 pages or longer, and were written by and for academics</li> 
                  <li>Each author wrote with a slightly different style and tone, and authors rarely built cohesively off of findings or work of another</li>
                  <li>There was a large variety in altitudes at which resources were written, as well as the scope that they would try to cover</li>
                </ul>
              </div>
            </div>
            <div className="bodyTextWrapper">
            <h3>Content Principles</h3>
            <p>During this analysis, we recognized a clear tension between the existing state of content in this space and the pain points experienced by institution faculty who were looking to achieve outcomes in their courses. In order to encourage future content development by the Every Learner team to align with the design we created for the platform, we created the following overarching content principles.</p>
            <ul>
              ...
              <li><strong>Action-oriented:</strong> Recognizing that users think about content in terms of the outcomes they want to achieve, rather than the resources they want to read.</li>
              <li><strong>Sequenced:</strong> Brought together in one place to create a sequenced, self-paced experience for the user.</li>
            </ul>
            <p>With these principles in mind, we then developed definitions for the two primary content types we would support on the platform, as well as a hierarchy connecting them.</p>
            </div> 
            <h4 className="imageHeading" style={{marginTop: '3rem'}}>Content Type Definitions</h4>
            ...
            <div className="photoGrid" style={{marginTop: '0'}}>
              <div className="photoGridElement">
                <Img alt="A flow showing the relationship between topics, questions, toolkits, and resources. Resources are configured into toolkits to answer questions within a topic." fluid={data.kitassetrelationship.childImageSharp.fluid}></Img>
                <p className="caption" style={{marginBottom: '0'}}>This mapping lays out the relationship between high-level topics, questions that faculty might have related to those topics, and the resources that can be configured into a toolkit to help answer those questions.</p>
              </div>
              <div className="photoGridElement">
                <Img alt="A flow showing the topic, kit, resource relationship, with a specific example for a question users might have about course measurement" fluid={data.kitassetexample.childImageSharp.fluid}></Img>
                <p className="caption" style={{marginBottom: '0'}}>Expanding on this model, this example shows how a set of related resources on impact studies might be configured into a toolkit to help answer a faculty member's question about measuring the impact of their digital learning implementation.</p>
              </div>

            </div>
            <h4 className="imageHeading">Low-Fidelity Flow</h4>
            <Img alt="A home page to topic page to toolkit page flow in Figma" className="projectImage" fluid={data.kitassetflow.childImageSharp.fluid} style={{marginTop: '0'}}></Img>
        <div className="bodyTextWrapper">
             <h3>Full Site Architecture</h3>
             <p>Once this base content hierarchy and flow was in place and approved by network stakeholders, we developed the following full information architecture for the platform.</p>     
        </div>

        <Img alt="Information architecture of the full site, including topic pages, toolkits, resources, and user profile page" className="projectImage" fluid={data.solveiav1.childImageSharp.fluid} style={{marginBottom: '0'}}></Img>
        <p className="caption">We prioritized implementing functionality for the four forms of content we already knew were being used by content creators: text, image, video, and document downloads. Given the small number of initial resources, we chose to de-prioritize search functionality and focus instead on topic browsing.</p>

        <div className="bodyTextWrapper">
            <h2>Technical Architecture</h2>
            <p>After creating this information architecture, our visual designer continued creating the basic page layouts and design specifications, while I conducted technical research to determine the best configuration of development resources for the build. Beyond budget, timing, and resource constraints, many of my technical decisions were guided heavily by the needs of the Every Learner Everywhere Content Team.</p>
          </div>
          ...
          <div className="bodyTextWrapper">
            ...
            <p>The needs of our content team to <strong>work independently</strong> and <strong>manage a growing number of resources</strong> prompted me to include <a href="htttps://flamelink.io" target="_blank" rel="noopener noreferrer">Flamelink.io</a>, a headless CMS, as part of our architecture.</p> 
            <p>Flamelink allows content editors to add, edit, or remove resources from the platform without any intervention from developers, using the content workflow I designed below.</p> 
        </div>
        <div className="photoGrid">
          <div className="photoGridElement">
            <Img alt="Part one of the content workflow diagram, where content editors update content in their preview environment and can see their changes on the preview site immediately" fluid={data.cmsworkflow1.childImageSharp.fluid}></Img>
            <p className="caption">1. Content editors can add and update content in a "preview" environment</p>
          </div>
          <div className="photoGridElement">
            <Img alt="Part two of the content workflow diagram, where stakeholders can view and approve content on the preview site" fluid={data.cmsworkflow2.childImageSharp.fluid}></Img>
            <p className="caption">2. Stakeholders can approve changes in the preview environment before users see them</p>
          </div>
          <div className="photoGridElement">
            <Img alt="Part three of the content workflow diagram, where a content manager can push the content changes to the production / live website" fluid={data.cmsworkflow3.childImageSharp.fluid}></Img>
            <p className="caption">3. Content admin can push changes from preview environment to the live platform</p>
          </div>
          <div className="photoGridElement">
            <Img alt="Part four of the content workflow diagram, where users can view the new content on the live site" fluid={data.cmsworkflow4.childImageSharp.fluid}></Img>
            <p className="caption">4. Users can view the content on the live platform</p>
          </div>
        </div>
        <div className="bodyTextWrapper">
          ...
          <p>After these 3.5 months of development, we were able to ship a version 1 of the platform and allow content editors to begin uploading, editing, and publishing content for public use. The following features were shipped as part of this initial version.</p>
        </div>
        <div className="photoGrid">
          <div className="photoGridElement">
            <Img alt="Home page of site, with topics that a user can browse through" fluid={data.homepage.childImageSharp.fluid}></Img>
            <p className="caption">Home page containing welcome text and digital learning topics that a user can browse through.</p>
          </div>
          <div className="photoGridElement">
            <Img alt="Topic page of site, which contains a brief definition of the topic, followed by toolkits and resources that have been tagged to the topic" fluid={data.topicpage.childImageSharp.fluid}></Img>
            <p className="caption">Topic pages, each containing a brief definition of the topic, followed by the toolkits and resources that have been tagged to the topic.</p>
          </div>
          <div className="photoGridElement">
            <Img alt="Toolkit page of the site, which contains an introduction, topics covered, resources, and surrounding reading" fluid={data.kitpage.childImageSharp.fluid}></Img>
            <p className="caption">Toolkit pages, each containing a key question, topics covered in the kit, and a resource walkthrough.</p>
          </div>
          <div className="photoGridElement">
            <Img alt="Resource page of site, which contains an introduction, a video, and text" fluid={data.resourcepage.childImageSharp.fluid}></Img>
            <p className="caption">Resource pages, each containing a title and introduction, and some combination of text, image, video, and/or documents to be downloaded.</p>
          </div>
          <div className="photoGridElement">
            <Img alt="User collection on the site, which contains a user's profile and the resources they have saved to their collection" fluid={data.usercollection.childImageSharp.fluid}></Img>
            <p className="caption">User collection page, containing a user's profile and the resources and toolkits they have added to their collection.</p>
          </div>
        </div>
        <div className="bodyTextWrapper">
          <h2 style={{marginTop: '1rem'}}>Ongoing Feature Development</h2>
          <div className="overview"><p>With the initial build of the platform in place, I continued to work closely with the Every Learner content team to identify additional interaction and content patterns that they wanted to support across their resources.</p></div>
        ...
        <Img alt="Update site architecture diagram, showing the additions of Search, Tables, and User Assessments" className="projectImage" fluid={data.solveiav2.childImageSharp.fluid} style={{margin: '0 auto'}}></Img>
        <p className="caption">This updated IA integrates the search, assessment, and content type features that were added as a result of our iterative feature development work.</p>
        <div className="bodyTextWrapper">
        ...
        <div className="videoWrapper">
           ...
           <p className="caption" style={{marginTop: '0'}}>Inline search results, available from anywhere on the site</p>
        </div>
        <div className="videoWrapper">
           ...
           <p className="caption" style={{marginTop: '0'}}>Full search results page with filtering</p>
        </div>
        <div className="bodyTextWrapper">
        ...
        <div className="videoWrapper">
          ...
          <p className="caption" style={{marginTop: '0'}}>User assessment feature in use. This assessment was created for institution faculty to help determine their readiness to use digital learning in their classroom.</p>
        </div>
        <div className="bodyTextWrapper">
        ...
        <div className="photoGrid">
          <div className="photoGridElement">
           <Img alt="Table within a resource, containing an accessibility approach matrix" fluid={data.table1.childImageSharp.fluid}></Img>
           <p className="caption">Table feature in use. Tables have a standard formatting that is applied, but allow a range of rich text and images in their contents.</p>
          </div>
          <div className="photoGridElement">
            <Img alt="Table within a resource, containing information about project titles and their role in conducting impact studies" fluid={data.table2.childImageSharp.fluid}></Img>
            <p className="caption">Table feature in use. Tables have a standard formatting that is applied, but allow a range of rich text and images in their contents.</p>
          </div>
          <div className="photoGridElement">
           <Img alt="Large pull quote text within an asset, containing a quote from a director on digital learning innovations"  fluid={data.pullquote.childImageSharp.fluid}></Img>
           <p className="caption">Pull quote feature in use</p>
          </div>
          <div className="photoGridElement">
           <Img alt="A blue callout box column within an asset, containing a side bar on Adaptive Courseware in Biology" fluid={data.calloutbox.childImageSharp.fluid}></Img>
